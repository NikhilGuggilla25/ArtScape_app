    ...
    render(){
        return <div className="sticky-top">
            ...
            <Navbar bg="primary" collapseOnSelect expand="lg" sticky="top" className="center">
                <Navbar.Brand href="#home" onClick={()=>{this.props.handleTab("home")}} style={{marginLeft: '2.3%'}}>
                    <h1 className="logo">ArtScape</h1>
                </Navbar.Brand>
                <Nav style={{marginLeft: 'auto'}} className="mr" >
                    <Nav.Link className="h5" 
                        key={6} 
                        onClick={()=>{this.props.handleTab("login")}} >
                            Login
                    </Nav.Link>
                </Nav>
                <Navbar.Toggle aria-controls="topbar-nav" />
                <Navbar.Collapse id="topbar-nav" className="max-width" style={{flexGrow: '0'}}>
