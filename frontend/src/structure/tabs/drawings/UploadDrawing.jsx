            ...
            <Modal.Body className="center">
                <div className={ "w-100" + (this.state.loading ? " d-none" : "")}>
                    <Dropzone
                        ...
                        accept={{"application/x-gcode": [".gcode"]}}  // This specifies the accepted file type for .gcode
                        noKeyboard
                    >
                        {({getRootProps, getInputProps, isDragActive}) => (
                            <div {...getRootProps()} className={"animated-background m-2 p-5 mh-100 d-flex justify-content-center align-items-center" + (isDragActive ? " drag-active" : "")}>
                                <input {...getInputProps()} />
                                <div className="d-block text-center">
                                    Drag and drop the .gcode file here <br />or click to open the file explorer
                                </div>
                            </div>
                        )}
                    </Dropzone>
